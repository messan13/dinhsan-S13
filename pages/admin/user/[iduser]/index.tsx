    ...
    return (
      ...
      <div className={style.profile_section}>
        <div className={style.avatar_container}>
          <div className={style.avatar}><p style={{color:'white' , fontSize:"80px",lineHeight:"150px",alignItems:"center",margin:"auto",textAlign:"center"}}>{data?.name?.charAt(0).toLocaleUpperCase()}</p></div> 
        </div>
